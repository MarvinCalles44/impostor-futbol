...
const footballPlayers = [
  ...
  "Bruno Fernandes", "Christian Eriksen", "Jude Bellingham", "Pedri González",
  ...
  "Gabriel Jesus", "Richarlison", "Raphinha", "Roberto Firmino", "Hakim Ziyech",
  "Christian Pulisic", "Alphonso Davies",
  "Jonathan David", "Son Heung-min", "Hirving Lozano", "André-Pierre Gignac", "Carlos Vela",
  "Diego Forlán", "Edinson Cavani", "Darwin Núñez", "Federico Valverde", "Nicolás Otamendi", "Lisandro Martínez", "Ángel Correa",
  "Julián Álvarez", "Enzo Fernández", "Papu Gómez", "Lautaro Martínez",
  "Yaya Touré", "Didier Drogba", "Samuel Eto’o", "Pierre-Emerick Aubameyang", "Declan Rice", "João Cancelo", "Diogo Jota RIP",
  , "Iago Aspas", "Álvaro Morata", "Fernando Torres", "David Villa",
  "Dani Olmo", "Ansu Fati", "Alejandro Garnacho",
  "Gonzalo Higuaín", "Carlos Tévez", "Juan Román Riquelme",
  "Diego Godín", "José Giménez", "Claudio Bravo", "Arturo Vidal","Alexis Sánchez",
  "Alexandre Lacazette", "Kingsley Coman", "Olivier Giroud", "Kylian Mbappé", "Aurélien Tchouaméni",
  "Eduardo Camavinga", "Dayot Upamecano", "Lucas Hernández", "Theo Hernández",
  "Ferland Mendy", "Benjamin Pavard", "Adrien Rabiot", "Anthony Martial",
  "Memphis Depay", "Georginio Wijnaldum", "Arjen Robben", "Robin van Persie",
  "Virgil van Dijk", "Denzel Dumfries", "Stefan de Vrij", 
  "Wesley Sneijder", "Zlatan Ibrahimović", "Henrikh Mkhitaryan","Luka Modric", "Ivan Rakitic", "Mario Mandzukic",
  "Hakan Çalhanoglu", "Sergi Roberto", "Dani Ceballos", "Lamine Yamal", "Yassine Bounou",
  "Achraf Hakimi", "Hakim Ziyech", "Sofyan Amrabat", "Mario Götze", "Marco Reus", "Thomas Müller",
  "Miroslav Klose", "Bastian Schweinsteiger","Mesut Özil",
  "Kai Havertz", "Timo Werner", "Leroy Sané", "Serge Gnabry",
  ...
  "Patrick Vieira", "Thierry Henry", "David Beckham", "Wayne Rooney", "Paul Scholes", "Eric Cantona", 
  "Oliver Kahn", "Luis Figo", "Raúl González", "Fernando Hierro", "Xabi Alonso",
  "Carles Puyol", "Pirlo", "Francesco Totti", "Frank Ribery", "Magico Gonzalez", "Fito Zelaya", "Mastantuono", "Arda Guler",
  "Dean Houjsen", "Alvaro Carreras", "Jamie Vardy", "Riyah Mahrez", "Eden Hazard", "Gareth Bale", "Cafu", "Ronald Koeman", 
  "Endrick", "Cubarsi", "Perisic", "Saliba", "Cold Palmer", "Isak", "Michael Olise", "Alexis MacAllister", "De Ligt", "Antony",
  "Moises Caicedo", "Kvicha Kvaratskhelia", "Martin Odegaard", "Vitinha", "Alessandro Bastoni", "Nicolo Barella", "Victor Gyokeres", 
  "Nuno Mendes", "Xavi Simons", "Rafael Leao", "Jules Kounde", "Gianluigui Donarumma", "Ademola Lookman", "Randall Kolo Muani",
  "Sandro Tonali", "Fermin Lopez", "Cuti Romero", "Federico Dimarco", "Raul Asencio", "Ferran Torres", "Santi Gimenez",
  "Jadon Sancho", "Jack Grealish", "Fabio Cannavaro", "Moukoko WInslow", "Zurito Jr", "Tartaglia", "Nelcon26", 
];
